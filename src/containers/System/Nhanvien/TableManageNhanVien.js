...
import './TableManageNhanVien.scss';
import *  as actions from "../../../store/actions";

class TableManageNhanVien extends Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(TableManageNhanVien);
